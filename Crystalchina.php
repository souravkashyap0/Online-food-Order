...
/* Footer starts*/
    ...
    <body>
        ...
        <h1 class="crystal"><i>Crystal China</i></h1>     
        </div>
        </section>
        <ul>
            <li><i>&#8377; Chinese</i></li>
...
<div class="productcont1">
        <div class="product1">
            <h3 class="productname">Wonton Soup </h3>
            <p>Freshly handmade Wonton</p>
            <img src="images/srcb64=aHR0cHM6Ly9kMXJhbHNvZ25qbmczNy5jbG91ZGZyb250Lm5ldC80YWYyMGZjMC02NTJiLTQ0MDEtOTJlNi0zNzhkZWFiNzZhNWQuanBlZw==.webp" width="210px">
            <p class="price">$5.05</p>
            <button class="addtocart">Add To Cart</button>
        </div>
        <div class="product1">
            <h3 class="productname">Soy Sauce Chow Mein</h3>
            <p>Chow mein with bokchoy, waterchestnut,carrot,celery</p>
            <img src="images/srcb64=aHR0cHM6Ly9kMXJhbHNvZ25qbmczNy5jbG91ZGZyb250Lm5ldC9jZmI0Nzk5Zi01NDM3LTQzYTUtYTRkMS01NWI4YTg5MTBlZDEuanBlZw==.webp" width="200px">
            <p class="price">$8.50</p>
            <button class="addtocart">Add To Cart</button>
        </div>
        <div class="product1">
            <h3 class="productname">Garlic Fried Chicken </h3>
            <p>Leg and thigh,spicy pistachio vinaigrette.</p>
            <img src="images/srcb64=aHR0cHM6Ly9kMXJhbHNvZ25qbmczNy5jbG91ZGZyb250Lm5ldC8yY2E3NTkyNS1lNGY5LTQyOTMtYmI0My00NWQxMTc5NzExMTAuanBlZw==.webp" width="210px">
