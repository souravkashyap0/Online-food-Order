...
/* Footer starts*/
    ...
    <body>
        ...
        <h1 class="crystal"><i>Emerald Italia</i></h1>     
        </div>
        </section>
        <ul>
            <li><i>&#8377; Italian</i></li>
...
<div class="productcont1">
        <div class="product1">
            <h3 class="productname">Cheese Ravioli </h3>
            <p>Freshly baked ravioli pasta dipped in sauce.</p>
            <img src="images/fdb2064a-2415-4996-b222-3290396e7d78.jpeg" width="200px">
            <p class="price">$5.05</p>
            <button class="addtocart">Add To Cart</button>
        </div>
        <div class="product1">
            <h3 class="productname">Pizza</h3>
            <p>Freshly baked pizza with a base of marinarasauce,mozzarella cheese.</p>
            <img src="images/5a880487-ff24-47a7-b1f9-4ba7c9a42862.jpeg" width="200px">
            <p class="price">$8.50</p>
            <button class="addtocart">Add To Cart</button>
        </div>
        <div class="product1">
            <h3 class="productname">Tiramisu </h3>
            <p>Delicious Special Tiramisu coffee dessert cake.</p>
            <img src="images/00483e60-0a0b-4355-9f58-7f030f08a743.jpeg" width="210px">
