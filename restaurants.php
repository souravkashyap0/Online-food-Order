    ...
    <body>
        ...
        <div class="container">
          ...
          <!--Header ends-->
           ...
           <script>
            ...
            <h1 style="font-family: 'Brush Script MT', cursive;color: white;font-size: 100px;text-align: center;"><b> Restaurants<b></h1>
        <!--Chinese,Indian ,Italian Restaurant Starts-->
      ...
      <div class="wrapper25 clearfix25 center25">       
       <a href="chinese.php"><div class="column25 inlineExample25 " id="box125"><b>Chinese</b></div></a>
        ...
        <!--Chinese,Indian,Italian Restaurant Ends-->
