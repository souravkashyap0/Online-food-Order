...
/* Chinese Restaurant ends */
    ...
    <body>
        ...
        <!--chinese restaurants begins-->
        
<h1 style="font-family: 'Brush Script MT',cursive;color: white;font-size: 100px;text-align: center;"><b>Chinese Restaurants<b></h1>
        
      <div class="vertWrapper25">
        
      <div class="wrapper25 clearfix25 center25">       
        <a href="Crystalchina.php"><div class="column25 inlineExample25 " id="box125"><b>Crystal China</b></div></a>
        <a href="#"><div class="column25 inlineExample25 " id="box126"><b>Chinese</b></div></a>
        <a href="#"><div class="column25 inlineExample25 "id="box127"><b>Chinese</b></div></a>
      </div>
    </div>
