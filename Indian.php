...
<html lang="en">
    <head>
        ...
        <style>
            body{
                background-image: url('images/photo-1476111707053-8b63eef7b918.jpg');
...
/* Chinese Restaurant ends */
    ...
    <body>
        ...
        <!-- Indian Restaurants Starts-->

    <h1 style="font-family: 'Brush Script MT',cursive;color: white;font-size: 100px;text-align: center;"><b>Indian Restaurants<b></h1>
        
      <div class="vertWrapper25">
        
      <div class="wrapper25 clearfix25 center25">       
        <a href="Diamond.php"><div class="column25 inlineExample25 " id="box125"><b>Diamond India</b></div></a>
        <a href="#"><div class="column25 inlineExample25 " id="box126"><b>Indian</b></div></a>
        <a href="#"><div class="column25 inlineExample25 "id="box127"><b>Indian</b></div></a>
      </div>
    </div>
        <!-- Indian Restaurants Ends-->
